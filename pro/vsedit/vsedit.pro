...
HEADERS += $${PROJECT_DIRECTORY}/src/script_editor/script_lexer_definitions.h
...
SOURCES += $${PROJECT_DIRECTORY}/src/script_editor/script_lexer_definitions.cpp
SOURCES += $${PROJECT_DIRECTORY}/src/script_editor/script_lexer.cpp
